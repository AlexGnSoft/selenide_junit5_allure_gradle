...
public class EditChannelPopUp extends AbstractPopUp{
    ...
    public final SelenideElement selectMessageTypeDropDown = $(By.xpath("//div[@id]/input[contains(@id,'msgTypes')]"));
    ...
    public final SelenideElement enterSearchTextMessageTypes = $(By.xpath("//div[@id='msgTypes-picker-innerCt']//input[@placeholder='Enter search text']"));
    ...
    public final SelenideElement removeAllMessageTypesBtn = $(By.xpath("//div[contains(@id,'msgTypes')]//span[contains(@id,'button')]/span[text()='Remove All']"));
    public final SelenideElement selectAllOfferTypesBtn = $(By.xpath("//div[contains(@id,'offerTypes')]//span[text()='Select All']"));
    public final SelenideElement selectAllMessageTypesBtn = $(By.xpath("//div[contains(@id,'msgTypes')]//span[text()='Select All']"));
    public final SelenideElement offerCheckBox = $(By.xpath("//div[@class='x-grid-cell-inner x-grid-checkcolumn-cell-inner']"));
    public final SelenideElement messageCheckBox = $(By.xpath("//div[@class='x-grid-cell-inner x-grid-checkcolumn-cell-inner']"));
